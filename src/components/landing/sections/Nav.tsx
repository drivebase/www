    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ display: 'flex', minWidth: 0, alignItems: 'center', justifyContent: 'flex-end', gap: '12px' }}
        >
          <a href={github.url} className="hidden w-20 shrink-0 items-center justify-end gap-1.5 text-sm tabular-nums text-white/60 hover:text-white transition-colors sm:flex" target="_blank" rel="noreferrer">
